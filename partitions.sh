...
(
    ...
    echo "Installing base system and required packages for xchroot"
    xbps-install -Syyu -R https://repo-default.voidlinux.org/current -r /mnt base-system cryptsetup grub-x86_64-efi btrfs-progs
